...
echo "   - Validate config: python scripts/validate_copilot_config.py"
echo "   - Diagnose PR issues: python scripts/diagnose_copilot_review.py --test"
echo "   - Test configuration: python scripts/test_copilot_fix.py"
echo ""
echo "📚 Documentation:"
echo "   - Setup Guide: docs/COPILOT_AGENTS_GUIDE.md"
echo "   - Troubleshooting: docs/COPILOT_TROUBLESHOOTING.md"
